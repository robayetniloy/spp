...
INSERT INTO `clientcars` (`car_id`, `admin_username`) VALUES
(14, 'admin'),
(15, 'admin'),
(16, 'admin');
...
CREATE TABLE `admin` (
  ...
  `admin_address` varchar(50) CHARACTER SET utf8 COLLATE utf8_estonian_ci NOT NULL,
...
INSERT INTO `admin` (`admin_username`, `admin_name`, `admin_phone`, `admin_email`, `admin_address`, `admin_password`) VALUES
('admin', 'admin', '15698433', 'admin@gmail.com', 'asdasds', 'admin');
...
('jim', 'jim', '01611163133', 'jim@gmial.com', 'afafa', '159');
...
INSERT INTO `driver` (`driver_id`, `driver_name`, `dl_number`, `driver_phone`, `driver_address`, `driver_gender`, `admin_username`, `driver_availability`) VALUES
(8, 'Test Driver', '456789', '156986', 'Abcd', 'male', 'admin', 'yes');
...
--
ALTER TABLE `clientcars`
  ADD CONSTRAINT `clientcars_ibfk_1` FOREIGN KEY (`admin_username`) REFERENCES `admin` (`admin_username`),
...
--
ALTER TABLE `driver`
  ADD CONSTRAINT `driver_ibfk_1` FOREIGN KEY (`admin_username`) REFERENCES `admin` (`admin_username`);
