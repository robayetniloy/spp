<html>
  ...
  <head>
    <title> Admin Signup | RIDERZ </title>
  ...
  <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        <div class="container">
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
              ...
              <li> <a href="clientview.php">Bookings</a></li>
...
$query = "INSERT into admin(admin_name,admin_username,admin_email,admin_phone,admin_address,admin_password) VALUES('" . $admin_name . "','" . $admin_username . "','" . $admin_email . "','" . $admin_phone . "','" . $admin_address ."','" . $admin_password ."')";
